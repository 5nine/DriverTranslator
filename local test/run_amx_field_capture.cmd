...
REM Interactive AMX field capture launcher.
...
echo ==========================================
echo AMX Field Capture Launcher ^(local test^)
echo ==========================================
echo Folder : %SCRIPT_DIR%
echo.
echo Enter decoder IPs separated by spaces.
...
echo Mode  : persistent + non_persistent + single-connection probe
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "& '%PS_SCRIPT%' -DecoderIps @(%DECODER_IPS_PS%) -Commands @(%COMMANDS_PS%) -RunPersistent -RunNonPersistent -ProbeSingleConnection"
