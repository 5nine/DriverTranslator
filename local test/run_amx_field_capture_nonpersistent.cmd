...
echo ==========================================
echo AMX Field Capture Launcher ^(non-persistent only^)
echo ==========================================
...
powershell -NoProfile -ExecutionPolicy Bypass -Command ^
  "& '%PS_SCRIPT%' -DecoderIps @(%DECODER_IPS_PS%) -Commands @(%COMMANDS_PS%) -RunNonPersistent"
